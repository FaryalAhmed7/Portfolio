...
const About = () => {
  ...
  return (
    <section id='about' className={`${inter.className} text-white`}>
      <div className='md:grid md:grid-cols-2 gap-8 item-center py-8 px-4 xl:gap-16 sm:py-16'>
        ...
        <div className='mt-4 md:mt-0 text-left flex flex-col h-full'>
          ...
          <div className="flex flex-row justify-start mt-8">
            ...
            <TabButton selectTab={() => handleTabChange("certificates")} active={tab === 'certificates'}>
              Certificates
            </TabButton>
          </div>
